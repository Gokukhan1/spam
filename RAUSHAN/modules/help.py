...
HELP_STRING = f"★ 𝗧𝗘𝗔𝗠 𝗭𝗬𝗥𝗢 𝗛𝗘𝗟𝗣 𝗠𝗘𝗡𝗨 ★\n\n» **ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴꜱ ꜰᴏʀ ʜᴇʟᴘ**\n» **ᴅᴇᴠᴇʟᴏᴘᴇʀ: @xeno_kakarot**"
...
HELP_BUTTON = [
    ...
    [
      Button.url("• ᴄʜᴀɴɴᴇʟ •", "https://t.me/PiratesBotRepo"),
      Button.url("• sᴜᴘᴘᴏʀᴛ •", "https://t.me/PiratesMainchat")
    ]
  ]
    ...
    if event.sender_id in SUDO_USERS:
        try:
          await event.client.send_file(event.chat_id,
              "https://files.catbox.moe/uzk9y2.jpg",
              caption=HELP_STRING,
              buttons=HELP_BUTTON
              )
    ...
    if event.query.user_id in SUDO_USERS:    
        await event.edit(
            ...
            buttons=[
              ...
              [
                Button.url("• ᴄʜᴀɴɴᴇʟ •", "https://t.me/PiratesBotRepo"),
                Button.url("• sᴜᴘᴘᴏʀᴛ •", "https://files.catbox.moe/uzk9y2.jpg")
              ]
            ]
          )
    else:
        await event.answer("Make Your Own Altron Bots !! @xeno_kakarot", cache_time=0, alert=True)
